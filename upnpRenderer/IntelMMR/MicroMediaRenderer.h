...
#define EXTENSION_AUDIO_MP4			".mp4"
#define EXTENSION_VIDEO_MP4			".mp4"
#define EXTENSION_VIDEO_AVI			".avi"
#define EXTENSION_VIDEO_MKV			".mkv"
#define EXTENSION_VIDEO_TS			".ts"
#define EXTENSION_VIDEO_M3U8		".m3u8"
#define EXTENSION_AUDIO_WEBM		".weba"
#define EXTENSION_VIDEO_WEBM		".webm"
...
enum MR_SupportedProtocolInfo
{
	...
	MR_PROTINFO_HTTP_AUDIO_MP4,
	MR_PROTINFO_HTTP_VIDEO_MP4,
	MR_PROTINFO_HTTP_VIDEO_AVI,
	MR_PROTINFO_HTTP_VIDEO_MKV,
	MR_PROTINFO_HTTP_VIDEO_TS,
	MR_PROTINFO_HTTP_AUDIO_M3U8,
	MR_PROTINFO_HTTP_VIDEO_M3U8,
	MR_PROTINFO_HTTP_AUDIO_WEBA,
	MR_PROTINFO_HTTP_VIDEO_WEBM
};
 ...
 */
extern void (*MROnMediaChangeRequest) (const char* mediaUri, char *CurrentURIMetaData);
 ...
 */
extern void (*MROnGetPositionRequest) (int* seconds, int* absSeconds, int* count, int* absCount, HWND *playerHandle);
 ...
 */
extern void (*MROnStateChangeRequest) (enum MR_Enum_States state, enum MR_Enum_PlaySpeeds playSpeeds, char *Media_URI);
...
extern void (*MROnGetTransportRequest) ();

extern void (*MROnGetMediaRequest) (HWND *playerHandle);

extern void (*MROnGetMediaPlayersList) (char* currentMediaPlayer, char* mediaPlayersList);
